...
【場所】ホテルブリランテ武蔵野（さいたま市中央区新都心2-2）`
    },
    {
      icon: "mikami.png",
      date: "2025-02-19",
      text: `卒業25周年同窓会を、今年秋頃に開催する予定で有志メンバーで準備を始めました（もう26年目になってるとか気にしない）。場所はさいたま市内を想定しています。詳細が固まってきたらこちらのグループで共有します。皆さんの連絡取れる同級生がいらっしゃいましたら、「秋頃集まるらしいぜ」など声掛けをしておいていただければ幸いです。`
    }
  ],
  links: {
    line: {
